...
public class ContasAReceberRespostaDTO {
    ...
    public static ContasAReceberRespostaDTO converterParaDTO(ContasAReceberModel contasAReceberModel) {
        return new ContasAReceberRespostaDTO(contasAReceberModel.getCodigo(), contasAReceberModel.getStatus(), contasAReceberModel.getRecebimento(), contasAReceberModel.getValorRecebido(), contasAReceberModel.getTipoRecebido(), contasAReceberModel.getDataDeVencimento(), contasAReceberModel.getDataDeRecebimento(), contasAReceberModel.getUsuario());
    }
    ...
    public static List<ContasAReceberRespostaDTO> converterLista(List<ContasAReceberModel> contas) {
        ...
        for (ContasAReceberModel conta : contas) {
            ContasAReceberRespostaDTO novaConta = new ContasAReceberRespostaDTO(conta.getCodigo(), conta.getStatus(), conta.getRecebimento(), conta.getValorRecebido(), conta.getTipoRecebido(), conta.getDataDeVencimento(), conta.getDataDeRecebimento(), conta.getUsuario());
